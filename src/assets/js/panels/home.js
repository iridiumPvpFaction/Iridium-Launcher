...
class Home {
    ...
    async init(config) {
        ...
        document.querySelector('.player-head').style.background = `url('https://www.iridiumpvp.fr/api/skin-api/avatars/face/${auth?.name}')`;
    }
    async news() {
    ...
    async instancesSelect() {
        ...
        for (let instance of instancesList) {
            ...
            } else console.log(`Initializing version ${instance.name}...`)
